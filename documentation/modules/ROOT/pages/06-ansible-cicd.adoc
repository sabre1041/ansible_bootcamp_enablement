...
----
+
. Replace the contents of the `extensions/molecule/dad_joke/converge.yml` file with the contents below
+
.converge.yml
...
----   
+
. Replace the contents of the `extensions/molecule/dad_joke/molecule.yml` file with the contents below
+
.molecule.yml
