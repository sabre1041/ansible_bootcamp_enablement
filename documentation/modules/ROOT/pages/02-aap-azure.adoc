...
Now that you understand managed AAP deployment on Azure, explore other deployment options:

* **xref:08-aap-openshift.adoc[AAP on OpenShift]**: Learn operator-based deployment on OpenShift Container Platform
* **Hybrid Deployments**: Combine managed Azure instances with on-premises automation controllers
* **Multi-Cloud Automation**: Extend your automation across Azure, AWS, and other cloud platforms
