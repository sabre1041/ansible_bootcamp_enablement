...
== 3: Execute your first Configuration as Code Playbook
...
[source,bash,role=execute,subs="verbatim,attributes"]
----
ansible-navigator run --pp=missing --eei={aap_controller_web_url}/config_as_code_ee:1.0 -m stdout playbooks/aap_config.yml -e env=dev
----
...
=== 3.2: Validate the configuration was applied
...
== 4: Configuring the Automation controller
...
=== 4.2: Configure Execution Environments
