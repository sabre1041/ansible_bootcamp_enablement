...
+
[source,yaml,role=execute,title="config/all/organizations.yml"]
----
---
...
+
[source,yaml,role=execute,title="config/all/teams.yml"]
----
---
aap_teams_all:
...
+
[source,yaml,role=execute,title="config/all/users.yml"]
----
---
...
+
[source,bash,role=execute,title="hosts"]
----
[dev]
localhost
----
...
+
[source,yaml,role=execute,title="playbooks/aap_config.yml"]
----
---
...
+
[source,yaml,role=execute,title="config/all/settings.yml"]
----
---
...
+
image::04-configuration-as-code/config_ee_v2.png[title="Config Execution Environment",125%,125%, link=self, window=blank]

[source,yaml,role=execute,title="config/all/execution_environments.yml"]
----
---
...
+
[source,yaml,role=execute,title="config/all/credential_types.yml"]
----
---
...
+
[source,yaml,role=execute,title="config/all/credentials.yml"]
----
---
...
----
+
image::04-configuration-as-code/credential_hub_v2.png[title="Credential",125%,125%, link=self, window=blank]
image::04-configuration-as-code/credential_gitea_v2.png[title="Credential",125%,125%, link=self, window=blank]
...
+
[source,yaml,role=execute,title="Update config/all/organizations.yml"]
----
---
aap_organizations_all:
  - name: config_as_code
...
[source,yaml,role=execute,title="config/all/projects.yml"]
----
---
...
image::04-configuration-as-code/project_v2.png[title="Project",125%,125%, link=self, window=_blank]
...
+
[source,yaml,role=execute,title="config/all/inventories.yml"]
----
---
...
----
+
image::04-configuration-as-code/inventories_v2.png[title="Inventory",125%,125%, link=self, window=_blank]
...
+
[source,yaml,role=execute,title="config/all/inventory_sources.yml"]
----
---
...
----
+
image::04-configuration-as-code/inventory_sources_v2.png[title="Inventory Sources",125%,125%, link=self, window=_blank]
...
+
[source,yaml,role=execute,title="config/all/job_templates.yml"]
----
---
...
----
+
image::04-configuration-as-code/aap_config_template_v3.png[title="AAP Config Template",125%,125%, link=self, window=_blank]
...
+
[source,yaml,role=execute,title="Updated playbooks/aap_config.yml"]
----
---
- name: Playbook to configure ansible controller
  hosts: localhost
