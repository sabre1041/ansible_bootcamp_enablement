...
=== Step 1.1: Configure Ansible to Use PAH via Environment Variables
...
==== Step 1.1.1: Obtaining Your PAH API Token
...
==== Step 1.1.2: Set Environment Variables
...
==== Step 1.2: Install required collections
- Next install the collections and containers.podman using `ansible-galaxy` command.
+
