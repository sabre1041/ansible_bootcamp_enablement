...
[source,yaml,role=execute,title="roles/db_server/meta/argument_specs.yml"]
----
argument_specs:
  main:
...
[source,text,role=execute,title="Dockerfile"]
----
...
[source,yaml,role=execute,title="extensions/molecule/db_server/requirements.yml"]
----
---
collections:
  - containers.podman
...
[source,yaml,role=execute,title="extensions/molecule/utils/playbooks/converge.yml"]
----
---
- name: Converge
  hosts: all
...
[source,yaml,role=execute,title="extensions/molecule/utils/playbooks/verify.yml"]
----
---
- name: Verify
  hosts: all
...
[source,yaml,role=execute,title="extensions/molecule/utils/playbooks/cleanup.yml"]
----
---
...
[source,yaml,role=execute,title="extensions/molecule/utils/playbooks/destroy.yml"]
----
---
...
[source,yaml,role=execute,title="extensions/molecule/utils/playbooks/noop.yml"]
----
---
- name: No-op
  hosts: localhost
...
ansible-galaxy collection publish -s https://{aap_controller_web_url}/api/galaxy/ ansible_bootcamp-my_collection-*.tar.gz --token YOUR_API_TOKEN_HERE
----
