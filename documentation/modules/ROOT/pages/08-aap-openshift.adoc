...
+
[source,yaml,role=execute,title="AnsibleAutomationPlatform CRD Spec"]
----
  controller:
    disabled: false
  eda:
...
+
[source,bash,role=execute,title="Check AWX Manage Commands"]
----
...
+
[source,yaml,role=execute,title="Custom AAP Deployment"]
----
