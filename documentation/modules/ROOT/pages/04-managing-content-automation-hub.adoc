...
ansible-galaxy collection build
ansible-galaxy collection publish -s https://aap-aap.{openshift_cluster_ingress_domain}/api/galaxy/ ansible_bootcamp-my_collection-1.0.1.tar.gz --token $PAH_API_TOKEN
----
