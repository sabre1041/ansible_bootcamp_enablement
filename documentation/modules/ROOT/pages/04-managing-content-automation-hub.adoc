...
WARNING: Remove the https:// Make sure to set your Git Config user parameters, 'git config --global user.email "gitea@ansible_bootcamp"' and 'git config --global user.name "gitea"from the base_image name
...
. Click on edit `community` copy and paste this in the requirements file section.
