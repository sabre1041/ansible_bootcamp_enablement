...
+
image::04-managing-content-automation-hub/remotes-edit-rh-certified.png[Edit RH-Certified Remote]
+
. Update the _Token_ field by pasting the token copied previously from Red Hat Automation Hub.
. Click **Save remote** to apply the changes.
  
image::04-managing-content-automation-hub/remotes-update-rh-certified.png[Update RH-Certified Remote]
